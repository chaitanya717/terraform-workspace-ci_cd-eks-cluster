...
user_data = "./terraform/vpc_with_Jenkins_server/module/jenkins-server/jenkin_install.sh"
...
user_data__kubectl = "./terraform/vpc_with_Jenkins_server/module/jenkins-server/kubectl_helm_install.sh"
